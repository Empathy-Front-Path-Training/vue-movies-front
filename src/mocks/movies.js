...
export const movieDetails = {
  ...
  tt0803093: {
    ...
    Writer:
      'Mark Millar (comic book: "The Ultimates"), Bryan Hitch (comic book: "The Ultimates"), Greg Johnson (screen story), Craig Kyle (screen story), Greg Johnson (screenplay), Joe Simon (comic book & character: Captain America), Jack Kirby (comic book & character: Captain America)',
    Actors: "Justin Gross, Grey Griffin, Michael Massee, Marc Worden",
    Plot:
  ...
  tt0054518: {
    ...
    Language: "English",
    Country: "UK",
    Awards: "Nominated for 4 Primetime Emmys. Another 1 win.",
    Poster:
      "https://m.media-amazon.com/images/M/MV5BZWQwZTdjMDUtNTY1YS00MDI0LWFkNjYtZDA4MDdmZjdlMDRlXkEyXkFqcGdeQXVyNjUwNzk3NDc@._V1_SX300.jpg",
    Ratings: [
      {
